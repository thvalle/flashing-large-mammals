...
To test for effects of the white LED flash I used the R programming language (\cite{RCoreTeam2020}),% relying on the packages tidyverse, overlap, surv (etc.)
to perform a time to event-analysis \cite{survival-package} and a GLMM analysis (lme4)? %TODO
per species.
...
%Survival-test, (unmarked)?, overlap, tidyverse,
