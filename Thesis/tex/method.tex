...
The IR CTs had been installed on trees 1-3 m from wildlife, human or tractor paths, 30-160 cm above ground level, and their distance from houses or roads varied to a large extent. %IMRkomm: Oppgi range? %TODO
...
Firstly, a facial recognition algorithm (FRA) was used to identify species on all pictures. %artificial intelligence software (AI)
...
This happened a few times, %IMRkomm: skriv antall ganger, evt summert varighet på periode, eller % av tiden
