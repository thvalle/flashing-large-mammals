...
# Simple regression to see if having a flash during the given period influence the frequency of the focal species. 
sp="raadyr"
...
new.dat$fit<-exp(-3.490394+0.006966*new.dat$time.deploy+0.089652*new.dat$flash)
