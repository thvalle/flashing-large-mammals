...
##  loc    (Intercept) 1.6674   1.2913  
## Number of obs: 13597, groups:  week, 52; loc, 47
## 
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)          -2.84502    0.37535  -7.580 3.47e-14 ***
## time.deploy          -0.42292    0.18847  -2.244   0.0248 *  
## flashIR              -0.25844    0.43955  -0.588   0.5566    
## flashLED             -0.13350    0.43799  -0.305   0.7605    
## time.deploy:flashIR   0.17020    0.23889   0.712   0.4762    
## time.deploy:flashLED  0.02834    0.22758   0.125   0.9009    
## ---
...
## tm.dply:LED  0.142 -0.627 -0.111 -0.227  0.435
```
...
##                time.deploy  Rejected      0.00 % [-0.73 -0.11]
##                 flash [IR] Undecided     13.83 % [-0.98  0.46]
##                flash [LED] Undecided     13.88 % [-0.85  0.59]
##   time.deploy * flash [IR] Undecided     25.45 % [-0.22  0.56]
##  time.deploy * flash [LED] Undecided     26.71 % [-0.35  0.40]
```
...
## 
##   - The effect of time.deploy is significantly negative (beta = -0.42, 95% CI [-0.79, -0.05], p < .05, Std. beta = -0.12)
##   - The effect of flash [IR] is non-significantly negative (beta = -0.26, 95% CI [-1.12, 0.60], p = 0.557, Std. beta = -0.18)
##   - The effect of flash [LED] is non-significantly negative (beta = -0.13, 95% CI [-0.99, 0.72], p = 0.761, Std. beta = -0.12)
##   - The interaction effect of flash [IR] on time.deploy is non-significantly positive (beta = 0.17, 95% CI [-0.30, 0.64], p = 0.476, Std. beta = 0.05)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly positive (beta = 0.03, 95% CI [-0.42, 0.47], p = 0.901, Std. beta = 7.96e-03)
```
...
## ---------------------------------------------------------------------------------------------------------------------------
## (Intercept)               |       -2.85 | [-3.58, -2.11] | -7.58 | Inf | < .001 |      -3.04 |    [-3.76, -2.32] |         
## time.deploy               |       -0.42 | [-0.79, -0.05] | -2.24 | Inf | 0.025  |      -0.12 |    [-0.22, -0.02] |         
## flash [IR]                |       -0.26 | [-1.12,  0.60] | -0.59 | Inf | 0.557  |      -0.18 |    [-1.02,  0.66] |         
## flash [LED]               |       -0.13 | [-0.99,  0.72] | -0.30 | Inf | 0.761  |      -0.12 |    [-0.96,  0.72] |         
## time.deploy * flash [IR]  |        0.17 | [-0.30,  0.64] |  0.71 | Inf | 0.476  |       0.05 |    [-0.08,  0.18] |         
## time.deploy * flash [LED] |        0.03 | [-0.42,  0.47] |  0.12 | Inf | 0.901  |   7.96e-03 |    [-0.12,  0.13] |         
##                           |             |                |       |     |        |            |                   |         
## AIC                       |             |                |       |     |        |            |                   |  7685.62
## BIC                       |             |                |       |     |        |            |                   |  7745.76
## R2 (conditional)          |             |                |       |     |        |            |                   |     0.38
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -0.6332 -0.2445 -0.1816 -0.1298 13.0525 
## 
## Random effects:
##  Groups Name        Variance Std.Dev.
##  loc    (Intercept) 0.74935  0.8657  
##  week   (Intercept) 0.07133  0.2671  
## Number of obs: 15249, groups:  loc, 53; week, 52
## 
## Fixed effects:
##                       Estimate Std. Error z value Pr(>|z|)    
## (Intercept)          -3.439163   0.256551 -13.405   <2e-16 ***
## time.deploy          -0.004586   0.237201  -0.019    0.985    
## flashIR               0.029434   0.315074   0.093    0.926    
## flashLED              0.176439   0.313581   0.563    0.574    
## time.deploy:flashIR  -0.020255   0.317696  -0.064    0.949    
## time.deploy:flashLED -0.093744   0.311291  -0.301    0.763    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## 
##   - The effect of time.deploy is non-significantly negative (beta = -4.59e-03, 95% CI [-0.47, 0.46], p = 0.985, Std. beta = -1.29e-03)
...
##   - The interaction effect of flash [IR] on time.deploy is non-significantly negative (beta = -0.02, 95% CI [-0.64, 0.60], p = 0.949, Std. beta = -5.69e-03)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly negative (beta = -0.09, 95% CI [-0.70, 0.52], p = 0.763, Std. beta = -0.03)
```
...
## time.deploy               |   -4.59e-03 | [-0.47,  0.46] |  -0.02 | Inf | 0.985  |  -1.29e-03 |    [-0.13,  0.13] |         
## flash [IR]                |        0.03 | [-0.59,  0.65] |   0.09 | Inf | 0.926  |       0.02 |    [-0.52,  0.56] |         
## flash [LED]               |        0.18 | [-0.44,  0.79] |   0.56 | Inf | 0.574  |       0.13 |    [-0.41,  0.68] |         
## time.deploy * flash [IR]  |       -0.02 | [-0.64,  0.60] |  -0.06 | Inf | 0.949  |  -5.69e-03 |    [-0.18,  0.17] |         
## time.deploy * flash [LED] |       -0.09 | [-0.70,  0.52] |  -0.30 | Inf | 0.763  |      -0.03 |    [-0.20,  0.15] |         
##                           |             |                |        |     |        |            |                   |         
## AIC                       |             |                |        |     |        |            |                   |  5740.11
## BIC                       |             |                |        |     |        |            |                   |  5801.17
## R2 (conditional)          |             |                |        |     |        |            |                   |     0.19
...
##                time.deploy Undecided     25.63 % [-0.39  0.39]
##                 flash [IR] Undecided     19.30 % [-0.49  0.55]
##                flash [LED] Undecided     19.39 % [-0.34  0.69]
##   time.deploy * flash [IR] Undecided     19.14 % [-0.54  0.50]
##  time.deploy * flash [LED] Undecided     19.53 % [-0.61  0.42]
```
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)          -4.48989    0.37066 -12.113   <2e-16 ***
## time.deploy           0.53552    0.28891   1.854   0.0638 .  
## flashIR               0.17132    0.38653   0.443   0.6576    
## flashLED              0.24443    0.38301   0.638   0.5234    
## time.deploy:flashIR   0.09617    0.35109   0.274   0.7842    
## time.deploy:flashLED  0.03651    0.33719   0.108   0.9138    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## tm.dply:fIR  0.269 -0.639 -0.480 -0.266       
## tm.dply:LED  0.294 -0.694 -0.277 -0.471  0.537
```
...
## Model failed to converge with max|grad| = 0.00454747 (tol = 0.002, component 1)
```
...
## 
##   - The effect of time.deploy is non-significantly positive (beta = 0.54, 95% CI [-0.03, 1.10], p = 0.064, Std. beta = 0.15)
##   - The effect of flash [IR] is non-significantly positive (beta = 0.17, 95% CI [-0.59, 0.93], p = 0.658, Std. beta = 0.22)
##   - The effect of flash [LED] is non-significantly positive (beta = 0.24, 95% CI [-0.51, 1.00], p = 0.523, Std. beta = 0.26)
##   - The interaction effect of flash [IR] on time.deploy is non-significantly positive (beta = 0.10, 95% CI [-0.59, 0.78], p = 0.784, Std. beta = 0.03)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly positive (beta = 0.04, 95% CI [-0.62, 0.70], p = 0.914, Std. beta = 0.01)
```
...
## Parameter                 | Coefficient |         95% CI |      z |  df |      p | Std. Coef. | Std. Coef. 95% CI |      Fit
## ----------------------------------------------------------------------------------------------------------------------------
## (Intercept)               |       -4.49 | [-5.22, -3.76] | -12.11 | Inf | < .001 |      -4.24 |    [-4.90, -3.58] |         
## time.deploy               |        0.54 | [-0.03,  1.10] |   1.85 | Inf | 0.064  |       0.15 |    [-0.01,  0.31] |         
## flash [IR]                |        0.17 | [-0.59,  0.93] |   0.44 | Inf | 0.658  |       0.22 |    [-0.45,  0.88] |         
## flash [LED]               |        0.24 | [-0.51,  1.00] |   0.64 | Inf | 0.523  |       0.26 |    [-0.40,  0.93] |         
## time.deploy * flash [IR]  |        0.10 | [-0.59,  0.78] |   0.27 | Inf | 0.784  |       0.03 |    [-0.17,  0.22] |         
## time.deploy * flash [LED] |        0.04 | [-0.62,  0.70] |   0.11 | Inf | 0.914  |       0.01 |    [-0.18,  0.20] |         
##                           |             |                |        |     |        |            |                   |         
## AIC                       |             |                |        |     |        |            |                   |  4728.27
## BIC                       |             |                |        |     |        |            |                   |  4788.59
## R2 (conditional)          |             |                |        |     |        |            |                   |     0.39
...
##                time.deploy  Rejected      4.18 % [ 0.06  1.01]
##                 flash [IR] Undecided     15.73 % [-0.46  0.81]
##                flash [LED] Undecided     15.87 % [-0.39  0.87]
##   time.deploy * flash [IR] Undecided     17.32 % [-0.48  0.67]
##  time.deploy * flash [LED] Undecided     18.03 % [-0.52  0.59]
```
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)          -4.15345    0.30209 -13.749   <2e-16 ***
## time.deploy           0.05295    0.38225   0.139    0.890    
## flashIR              -0.08199    0.34930  -0.235    0.814    
## flashLED              0.30186    0.33885   0.891    0.373    
## time.deploy:flashIR   0.42723    0.49553   0.862    0.389    
## time.deploy:flashLED -0.05865    0.47747  -0.123    0.902    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## time.deploy -0.626                            
## flashIR     -0.680  0.462                     
## flashLED    -0.712  0.484  0.746              
## tm.dply:fIR  0.372 -0.629 -0.670 -0.357       
## tm.dply:LED  0.431 -0.703 -0.383 -0.655  0.529
```
...
## 
##   - The effect of time.deploy is non-significantly positive (beta = 0.05, 95% CI [-0.70, 0.80], p = 0.890, Std. beta = 0.01)
...
##   - The interaction effect of flash [IR] on time.deploy is non-significantly positive (beta = 0.43, 95% CI [-0.54, 1.40], p = 0.389, Std. beta = 0.12)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly negative (beta = -0.06, 95% CI [-0.99, 0.88], p = 0.902, Std. beta = -0.02)
```
...
## time.deploy               |        0.05 | [-0.70,  0.80] |   0.14 | Inf | 0.890  |       0.01 |    [-0.20,  0.23] |         
## flash [IR]                |       -0.08 | [-0.77,  0.60] |  -0.23 | Inf | 0.814  |       0.12 |    [-0.39,  0.62] |         
## flash [LED]               |        0.30 | [-0.36,  0.97] |   0.89 | Inf | 0.373  |       0.27 |    [-0.23,  0.78] |         
## time.deploy * flash [IR]  |        0.43 | [-0.54,  1.40] |   0.86 | Inf | 0.389  |       0.12 |    [-0.15,  0.39] |         
## time.deploy * flash [LED] |       -0.06 | [-0.99,  0.88] |  -0.12 | Inf | 0.902  |      -0.02 |    [-0.28,  0.25] |         
##                           |             |                |        |     |        |            |                   |         
## AIC                       |             |                |        |     |        |            |                   |  2956.30
## BIC                       |             |                |        |     |        |            |                   |  3015.41
## R2 (conditional)          |             |                |        |     |        |            |                   |     0.19
...
##                time.deploy Undecided     15.90 % [-0.58  0.68]
##                 flash [IR] Undecided     17.41 % [-0.66  0.49]
##                flash [LED] Undecided     17.94 % [-0.26  0.86]
##   time.deploy * flash [IR] Undecided     12.27 % [-0.39  1.24]
##  time.deploy * flash [LED] Undecided     12.73 % [-0.84  0.73]
```
...
## Fixed effects:
##                       Estimate Std. Error z value Pr(>|z|)    
## (Intercept)          -3.891255   0.407622  -9.546  < 2e-16 ***
## time.deploy          -0.797491   0.490225  -1.627  0.10378    
## flashIR              -0.009774   0.498347  -0.020  0.98435    
## flashLED             -0.687263   0.527079  -1.304  0.19226    
## time.deploy:flashIR   0.519101   0.645038   0.805  0.42096    
## time.deploy:flashLED  1.942177   0.655832   2.961  0.00306 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## 
##   - The effect of time.deploy is non-significantly negative (beta = -0.80, 95% CI [-1.76, 0.16], p = 0.104, Std. beta = -0.22)
##   - The effect of flash [IR] is non-significantly negative (beta = -9.77e-03, 95% CI [-0.99, 0.97], p = 0.984, Std. beta = 0.23)
##   - The effect of flash [LED] is non-significantly negative (beta = -0.69, 95% CI [-1.72, 0.35], p = 0.192, Std. beta = 0.21)
##   - The interaction effect of flash [IR] on time.deploy is non-significantly positive (beta = 0.52, 95% CI [-0.75, 1.78], p = 0.421, Std. beta = 0.15)
##   - The interaction effect of flash [LED] on time.deploy is significantly positive (beta = 1.94, 95% CI [0.66, 3.23], p < .01, Std. beta = 0.55)
```
...
## time.deploy               |       -0.80 | [-1.76,  0.16] | -1.63 | Inf | 0.104  |      -0.22 |    [-0.50,  0.05] |        
## flash [IR]                |   -9.77e-03 | [-0.99,  0.97] | -0.02 | Inf | 0.984  |       0.23 |    [-0.58,  1.04] |        
## flash [LED]               |       -0.69 | [-1.72,  0.35] | -1.30 | Inf | 0.192  |       0.21 |    [-0.61,  1.03] |        
## time.deploy * flash [IR]  |        0.52 | [-0.75,  1.78] |  0.80 | Inf | 0.421  |       0.15 |    [-0.21,  0.50] |        
## time.deploy * flash [LED] |        1.94 | [ 0.66,  3.23] |  2.96 | Inf | 0.003  |       0.55 |    [ 0.19,  0.91] |        
##                           |             |                |       |     |        |            |                   |        
## AIC                       |             |                |       |     |        |            |                   | 1743.43
## BIC                       |             |                |       |     |        |            |                   | 1798.64
## R2 (conditional)          |             |                |       |     |        |            |                   |    0.20
...
##                time.deploy Undecided      6.75 % [-1.60  0.01]
##                 flash [IR] Undecided     12.20 % [-0.83  0.81]
##                flash [LED] Undecided     11.53 % [-1.55  0.18]
##   time.deploy * flash [IR] Undecided      9.43 % [-0.54  1.58]
##  time.deploy * flash [LED]  Rejected      0.00 % [ 0.86  3.02]
```
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)           -4.8175     0.5850  -8.235   <2e-16 ***
## time.deploy           -1.8473     1.1670  -1.583    0.113    
## flashIR               -0.2004     0.7207  -0.278    0.781    
## flashLED               0.1454     0.7165   0.203    0.839    
## time.deploy:flashIR    2.0869     1.3664   1.527    0.127    
## time.deploy:flashLED   2.1646     1.3629   1.588    0.112    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## 
##   - The effect of time.deploy is non-significantly negative (beta = -1.85, 95% CI [-4.13, 0.44], p = 0.113, Std. beta = -0.52)
...
##   - The interaction effect of flash [IR] on time.deploy is non-significantly positive (beta = 2.09, 95% CI [-0.59, 4.76], p = 0.127, Std. beta = 0.59)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly positive (beta = 2.16, 95% CI [-0.51, 4.84], p = 0.112, Std. beta = 0.61)
```
...
## time.deploy               |       -1.85 | [-4.13,  0.44] | -1.58 | Inf | 0.113  |      -0.52 |    [-1.17,  0.12] |       
## flash [IR]                |       -0.20 | [-1.61,  1.21] | -0.28 | Inf | 0.781  |       0.76 |    [-0.25,  1.77] |       
## flash [LED]               |        0.15 | [-1.26,  1.55] |  0.20 | Inf | 0.839  |       1.15 |    [ 0.15,  2.14] |       
## time.deploy * flash [IR]  |        2.09 | [-0.59,  4.76] |  1.53 | Inf | 0.127  |       0.59 |    [-0.17,  1.35] |       
## time.deploy * flash [LED] |        2.16 | [-0.51,  4.84] |  1.59 | Inf | 0.112  |       0.61 |    [-0.14,  1.37] |       
##                           |             |                |       |     |        |            |                   |       
## AIC                       |             |                |       |     |        |            |                   | 686.23
## BIC                       |             |                |       |     |        |            |                   | 739.94
## R2 (conditional)          |             |                |       |     |        |            |                   |   0.18
...
##                time.deploy Undecided      4.49 % [-3.77  0.07]
##                 flash [IR] Undecided      8.44 % [-1.39  0.99]
##                flash [LED] Undecided      8.49 % [-1.03  1.32]
##   time.deploy * flash [IR] Undecided      4.45 % [-0.16  4.33]
##  time.deploy * flash [LED] Undecided      3.95 % [-0.08  4.41]
```
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)           -3.9063     0.3569 -10.944   <2e-16 ***
## time.deploy            0.2975     0.2659   1.119    0.263    
## flashIR                0.3828     0.4207   0.910    0.363    
## flashLED               0.2493     0.4228   0.590    0.555    
## time.deploy:flashIR   -0.4220     0.3359  -1.256    0.209    
## time.deploy:flashLED   0.0107     0.3469   0.031    0.975    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## time.deploy -0.378                            
## flashIR     -0.759  0.268                     
## flashLED    -0.760  0.287  0.906              
## tm.dply:fIR  0.243 -0.622 -0.395 -0.215       
## tm.dply:LED  0.250 -0.655 -0.224 -0.410  0.510
```
...
## 
##   - The effect of time.deploy is non-significantly positive (beta = 0.30, 95% CI [-0.22, 0.82], p = 0.263, Std. beta = 0.08)
...
##   - The interaction effect of flash [IR] on time.deploy is non-significantly negative (beta = -0.42, 95% CI [-1.08, 0.24], p = 0.209, Std. beta = -0.12)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly positive (beta = 0.01, 95% CI [-0.67, 0.69], p = 0.975, Std. beta = 3.02e-03)
```
...
## time.deploy               |        0.30 | [-0.22,  0.82] |   1.12 | Inf | 0.263  |       0.08 |    [-0.06,  0.23] |         
## flash [IR]                |        0.38 | [-0.44,  1.21] |   0.91 | Inf | 0.363  |       0.19 |    [-0.57,  0.95] |         
## flash [LED]               |        0.25 | [-0.58,  1.08] |   0.59 | Inf | 0.555  |       0.25 |    [-0.50,  1.01] |         
## time.deploy * flash [IR]  |       -0.42 | [-1.08,  0.24] |  -1.26 | Inf | 0.209  |      -0.12 |    [-0.30,  0.07] |         
## time.deploy * flash [LED] |        0.01 | [-0.67,  0.69] |   0.03 | Inf | 0.975  |   3.02e-03 |    [-0.19,  0.19] |         
##                           |             |                |        |     |        |            |                   |         
## AIC                       |             |                |        |     |        |            |                   |  4925.04
## BIC                       |             |                |        |     |        |            |                   |  4984.79
## R2 (conditional)          |             |                |        |     |        |            |                   |     0.33
...
##                time.deploy Undecided     22.87 % [-0.14  0.73]
##                 flash [IR] Undecided     14.45 % [-0.31  1.07]
##                flash [LED] Undecided     14.38 % [-0.45  0.94]
##   time.deploy * flash [IR] Undecided     18.10 % [-0.97  0.13]
##  time.deploy * flash [LED] Undecided     17.53 % [-0.56  0.58]
```
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.2366 -0.1804 -0.1229 -0.0815 19.3056 
## 
## Random effects:
##  Groups Name        Variance Std.Dev.
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)           -4.8156     0.4139 -11.636  < 2e-16 ***
## time.deploy            0.6808     0.4077   1.670  0.09490 .  
## flashIR                0.9088     0.4716   1.927  0.05398 .  
## flashLED               0.6104     0.4767   1.280  0.20039    
## time.deploy:flashIR   -1.4585     0.5115  -2.851  0.00435 ** 
## time.deploy:flashLED  -0.1454     0.5006  -0.291  0.77143    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## time.deploy -0.543                            
## flashIR     -0.781  0.456                     
## flashLED    -0.760  0.436  0.887              
## tm.dply:fIR  0.398 -0.742 -0.532 -0.353       
## tm.dply:LED  0.382 -0.719 -0.374 -0.556  0.589
```
...
## 
##   - The effect of time.deploy is non-significantly positive (beta = 0.68, 95% CI [-0.12, 1.48], p = 0.095, Std. beta = 0.19)
##   - The effect of flash [IR] is non-significantly positive (beta = 0.91, 95% CI [-0.02, 1.83], p = 0.054, Std. beta = 0.24)
##   - The effect of flash [LED] is non-significantly positive (beta = 0.61, 95% CI [-0.32, 1.54], p = 0.200, Std. beta = 0.54)
##   - The interaction effect of flash [IR] on time.deploy is significantly negative (beta = -1.46, 95% CI [-2.46, -0.46], p < .01, Std. beta = -0.41)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly negative (beta = -0.15, 95% CI [-1.13, 0.84], p = 0.771, Std. beta = -0.04)
```
...
## Parameter                 | Coefficient |         95% CI |      z |  df |      p | Std. Coef. | Std. Coef. 95% CI |     Fit
## ---------------------------------------------------------------------------------------------------------------------------
## (Intercept)               |       -4.82 | [-5.63, -4.00] | -11.64 | Inf | < .001 |      -4.50 |    [-5.19, -3.82] |        
## time.deploy               |        0.68 | [-0.12,  1.48] |   1.67 | Inf | 0.095  |       0.19 |    [-0.03,  0.42] |        
## flash [IR]                |        0.91 | [-0.02,  1.83] |   1.93 | Inf | 0.054  |       0.24 |    [-0.55,  1.02] |        
## flash [LED]               |        0.61 | [-0.32,  1.54] |   1.28 | Inf | 0.200  |       0.54 |    [-0.24,  1.32] |        
## time.deploy * flash [IR]  |       -1.46 | [-2.46, -0.46] |  -2.85 | Inf | 0.004  |      -0.41 |    [-0.69, -0.13] |        
## time.deploy * flash [LED] |       -0.15 | [-1.13,  0.84] |  -0.29 | Inf | 0.771  |      -0.04 |    [-0.32,  0.23] |        
##                           |             |                |        |     |        |            |                   |        
## AIC                       |             |                |        |     |        |            |                   | 2901.88
## BIC                       |             |                |        |     |        |            |                   | 2960.09
## R2 (conditional)          |             |                |        |     |        |            |                   |    0.30
...
##                time.deploy  Rejected      6.69 % [ 0.01  1.35]
##                 flash [IR]  Rejected      0.00 % [ 0.13  1.68]
##                flash [LED] Undecided     12.75 % [-0.17  1.39]
##   time.deploy * flash [IR]  Rejected      0.00 % [-2.30 -0.62]
##  time.deploy * flash [LED] Undecided     12.14 % [-0.97  0.68]
```
...
## Fixed effects:
##                      Estimate Std. Error z value Pr(>|z|)    
## (Intercept)           -5.9507     0.5437 -10.945  < 2e-16 ***
## time.deploy            0.7746     0.7975   0.971  0.33143    
## flashIR                1.6893     0.5793   2.916  0.00354 ** 
## flashLED               0.7608     0.6066   1.254  0.20977    
## time.deploy:flashIR   -0.9420     0.8834  -1.066  0.28626    
## time.deploy:flashLED   0.2690     0.9112   0.295  0.76780    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## tm.dply:fIR  0.685 -0.853 -0.799 -0.631       
...
## 
##   - The effect of time.deploy is non-significantly positive (beta = 0.77, 95% CI [-0.79, 2.34], p = 0.331, Std. beta = 0.22)
...
##   - The interaction effect of flash [IR] on time.deploy is non-significantly negative (beta = -0.94, 95% CI [-2.67, 0.79], p = 0.286, Std. beta = -0.26)
##   - The interaction effect of flash [LED] on time.deploy is non-significantly positive (beta = 0.27, 95% CI [-1.52, 2.05], p = 0.768, Std. beta = 0.08)
```
...
## Parameter                 | Coefficient |         95% CI |      z |  df |      p | Std. Coef. | Std. Coef. 95% CI |     Fit
## ---------------------------------------------------------------------------------------------------------------------------
## (Intercept)               |       -5.95 | [-7.02, -4.89] | -10.94 | Inf | < .001 |      -5.59 |    [-6.23, -4.95] |        
## time.deploy               |        0.77 | [-0.79,  2.34] |   0.97 | Inf | 0.331  |       0.22 |    [-0.22,  0.66] |        
## flash [IR]                |        1.69 | [ 0.55,  2.82] |   2.92 | Inf | 0.004  |       1.25 |    [ 0.56,  1.95] |        
## flash [LED]               |        0.76 | [-0.43,  1.95] |   1.25 | Inf | 0.210  |       0.89 |    [ 0.18,  1.59] |        
## time.deploy * flash [IR]  |       -0.94 | [-2.67,  0.79] |  -1.07 | Inf | 0.286  |      -0.26 |    [-0.75,  0.22] |        
## time.deploy * flash [LED] |        0.27 | [-1.52,  2.05] |   0.30 | Inf | 0.768  |       0.08 |    [-0.43,  0.58] |        
##                           |             |                |        |     |        |            |                   |        
## AIC                       |             |                |        |     |        |            |                   | 1810.36
## BIC                       |             |                |        |     |        |            |                   | 1869.51
## R2 (conditional)          |             |                |        |     |        |            |                   |    0.22
...
## 
##                  Parameter        H0 inside ROPE        90% CI
##                (Intercept)  Rejected      0.00 % [-6.85 -5.06]
##                time.deploy Undecided      7.62 % [-0.54  2.09]
##                 flash [IR]  Rejected      0.00 % [ 0.74  2.64]
##                flash [LED] Undecided     10.02 % [-0.24  1.76]
##   time.deploy * flash [IR] Undecided      6.88 % [-2.39  0.51]
##  time.deploy * flash [LED] Undecided      6.67 % [-1.23  1.77]
```
...
## m_rev   | glmerMod | 5740.112 | 5801.171 |      0.146 |  6.488e-04 | 0.145 | 0.221 |            17.87%
```
